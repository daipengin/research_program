...
class PhaseGapErrorPlotConfig:
    results_dir: Path = Path("results")
    graphs_dir: Path = Path("phase_gap_error_graphs")
...
class AggregatedPhaseGapErrorPlotConfig:
    aggregated_stats_dir: Path = Path("aggregated_stats")
    graphs_dir: Path = Path("aggregated_stats_graphs")
...
class AggregatedPhaseGapErrorOverlayPlotConfig:
    aggregated_stats_dir: Path = Path("aggregated_stats")
    graphs_dir: Path = Path("aggregated_stats_overlay_graphs")
...
class ConvergenceAnalysisConfig:
    aggregated_stats_dir: Path = Path("aggregated_stats")
    graphs_dir: Path = Path("convergence_graphs")
...
class PerPlotConfig:
    results_dir: Path = Path("results")
    graphs_dir: Path = Path("per_graphs")
...
class ComparePerByDevicesIntervalConfig:
    results_dir: Path = Path("results")
    graphs_dir: Path = Path("compare_per_graphs")
...
class PerAlignedPlotConfig:
    results_dir: Path = Path("results")
    graphs_dir: Path = Path("per_aligned_graphs")
...
PER_ALIGNED_PLOT_CONFIG = PerAlignedPlotConfig(
    ...
    graphs_dir=Path("per_aligned_graphs"),
